...
namespace Decarator
{
    internal class Program
    {
        ...
        {
            //The Decorator design pattern allows for the dynamic addition of behavior or responsibilities to an object by wrapping it in a decorator class,
            //providing a flexible alternative to subclassing for extending functionality.


            var personalCar = new PersonalCar { Brand = "BMW", Model = "3.20", HirePrice = 2500 };
