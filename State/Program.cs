...
namespace State
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //by encapsulating state-specific behavior within distinct state objects, making the object appear to change its class and promoting cleaner and more maintainable code.
